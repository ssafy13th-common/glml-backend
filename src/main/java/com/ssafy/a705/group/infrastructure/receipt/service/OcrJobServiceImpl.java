package com.ssafy.a705.group.infrastructure.receipt.service;

import com.ssafy.a705.group.domain.receipt.entity.OcrStatus;
import com.ssafy.a705.group.domain.receipt.service.OcrJobService;
import com.ssafy.a705.group.presentation.receipt.dto.request.FlaskOcrReq;
import com.ssafy.a705.group.presentation.receipt.dto.request.OcrExecuteReq;
import com.ssafy.a705.group.presentation.receipt.dto.response.FlaskOcrRes;
import com.ssafy.a705.group.presentation.receipt.dto.response.OcrExecuteRes;
import com.ssafy.a705.group.presentation.receipt.dto.response.ReceiptItem;
import com.ssafy.a705.group.domain.receipt.exception.FlaskApiException;
import com.ssafy.a705.group.domain.receipt.exception.FlaskException;
import com.ssafy.a705.group.domain.receipt.exception.FlaskTimeoutException;
...
public class OcrJobServiceImpl implements OcrJobService {
    ...
    public OcrExecuteRes execute(OcrExecuteReq ocrExecuteReq) {
